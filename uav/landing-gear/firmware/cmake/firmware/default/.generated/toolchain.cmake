...
set(MP_CC_DIR "/Applications/microchip/xc8/v2.50" CACHE PATH "Legacy variable from MPLAB X pointing to the compiler base directory")
set(CMAKE_C_COMPILER "/Applications/microchip/xc8/v2.50/bin/xc8-cc" CACHE FILEPATH "Path to the compiler binary")
...
set(CMAKE_ASM_COMPILER "/Applications/microchip/xc8/v2.50/bin/xc8-cc" CACHE FILEPATH "Path to the compiler binary.")

# Legacy variable from MPLAB X pointing to the assembler binary.
set(MP_AS ${CMAKE_ASM_COMPILER})

set(MP_LD "/Applications/microchip/xc8/v2.50/bin/xc8-cc" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the linker binary.")

set(MP_AR "/Applications/microchip/xc8/v2.50/bin/xc8-ar" CACHE FILEPATH "Legacy variable from MPLAB X pointing to the archiver binary.")

set(CMAKE_AR "/Applications/microchip/xc8/v2.50/bin/xc8-ar" CACHE FILEPATH "Path to the archiver binary.")
